...
| `/teacher` | 시험지 사물 | 교실에 붙일 초대장 — 반 이름 · 큰 코드 · QR 한 장, 반이 없으면 적는 대로 채워지는 미리보기(모션 0) | **서명 있음**(2026-09-19 골든 13호 [golden/teacher.md](docs/design/golden/teacher.md) · DD-33 — 반이 있는 상태는 계약 테스트만) |
