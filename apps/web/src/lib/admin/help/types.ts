...
/**
 * 화면 하나의 도식. 종류가 둘뿐인 이유: 늘리면 렌더가 늘고, 렌더가 늘면 아무도
 * 새 화면에 도식을 안 붙인다. 이 둘로 공정 라인·발주 걸음·드레인 고리·검수 층·기호표가 다 된다.
 */
