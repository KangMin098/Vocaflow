      ...
      steps: [
        {
          ...
          done: '카드가 강조 테두리(잉크색)로 바뀌고 아래에 그 유형이 요구하는 값만 나타난다.',
        },
        {
          title: '값 채우기',
          detail:
    ...
    screen: {
      ...
      drain: {
        ...
        verify: [
          ...
          '**서가에서 눈으로 확인한다** — /library/vocab 표지 왼쪽 위에 kicker, 오른쪽 위에 권 번호, '
            + '아래에 계열 줄이 보인다. 각인만 되고 화면이 안 바뀌면 그 각인은 장식이다 '
        ...
        recovery: [
          ...
          '규격이 화면에서 안 맞으면 **코드가 아니라 캔버스를 고친다** — 화면 값은 각인에서 오고, '
            ...
            + '실제 사례: 480px 판형에서 정한 제목 2줄이 150px 타일에서 여섯 권의 제목을 잘랐다 → 규격을 4줄로.',
        ],
      },
    },
  },
