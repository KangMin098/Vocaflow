...
export const LEARNER_ROUTES: LearnerRoute[] = [
  ...
  // 2026-09-24 — 기출분석공간 재설계(docs/csat/ia-design.md): 홈 · 서가 · 내 기록이 같은 메뉴를 쓴다.
  { path: '/csat', screen: 'csat', label: '기출분석공간', group: 'main', kind: 'screen' },
  {
    path: '/csat/browse',
    screen: 'csat-browse',
    label: '기출 전체 서가',
    says: '목적 · 유형 · 회차로 좁혀 번호 칩에서 바로 문항 해설로 간다.',
    group: 'main',
    kind: 'screen',
  },
  {
    ...
    screen: 'csat-record',
    label: '기출 내 기록',
    says: '본 유형 · 연 문항 · 만난 오답 계열 · 학습한 날 · 다음 복습.',
    group: 'main',
    kind: 'screen',
    section: '학습 관리',
  },
  ...
  },
  {
    ...
    label: '내 공식',
    says: '모은 출제 공식 · 최근 예측 적중률 · 함정 계열 커버리지.',
    group: 'main',
    kind: 'screen',
    section: '학습 관리',
  },
