...
// 띄우던 그라데이션 상자. 그 컬럼은 아무도 채우지 않고(→ memory-horizon.ts 주석), 채워지더라도
// 정의가 `stability >= 21` 이라 대부분의 학습자에게 **몇 달 동안 0** 이다. 회고 화면의
// 주인공 자리에 몇 달간 0을 두는 것은 "당신은 아무것도 이루지 못했다" 를 매일 반복하는 것과 같다.
//
// 왜 하필 지속 시간인가:
