...
export function RecallPhase({ visible, progress, label }: RecallPhaseProps) {
  return (
    <div
      ...
      aria-live="polite"
    >
      <p className="mb-1.5 flex items-center gap-2 font-display text-[11px] font-[600] tracking-[0.04em] text-[var(--p)]">
      ...
      <div className="relative h-[3px] w-[200px] overflow-hidden rounded-[var(--r-full)] bg-[var(--bg2)]">
        <div
          className="absolute left-0 top-0 h-full rounded-[var(--r-full)] bg-[var(--p)] transition-[width] duration-[var(--dur-fast)] ease-linear"
