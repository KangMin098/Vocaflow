  ...
  return (
    <div className="mt-1">
      ...
      {truncated > 0 && (
        <p
          role="alert"
          className="mt-2 inline-flex items-start gap-2 rounded-[var(--r-md)] border border-[var(--warning)]/30 bg-[var(--warning-light)] px-3 py-2 font-body text-[11px] text-[var(--warning-ink)]"
        >
