            ...
            <ul className="flex flex-col divide-y divide-[var(--bd)]/40">
              {words.map((w) => (
                <li key={w.word} className="flex items-start gap-3 py-2.5">
                  <span className="mt-0.5 w-7 shrink-0 font-display text-[11px] font-[700] tabular-nums text-[var(--t3)]">
                    #{w.rank}
                  </span>
                  <div className="min-w-0 flex-1">
                    <div className="flex flex-wrap items-baseline gap-2">
                      ...
                      {w.pos && (
                        <span className="font-body text-[10px] text-[var(--t3)]">{w.pos}</span>
                      )}
                      {w.vLevel != null && (
                    ...
                    {w.firstSentence && (
                      <p className="mt-0.5 line-clamp-2 font-english text-[11px] italic leading-snug text-[var(--t3)]">
                        “{w.firstSentence}”
                      </p>
                    )}
                  </div>
                  <button
                    ...
                    className="mt-0.5 shrink-0 rounded-full p-1.5 text-[var(--t3)] transition-colors hover:bg-[var(--bg2)] hover:text-[var(--p)]"
                  >
