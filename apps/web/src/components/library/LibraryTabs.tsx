      ...
      {LIBRARY_TABS.map((tab) => {
        ...
        return (
          <Link
            ...
            className={`flex min-h-[44px] shrink-0 items-center gap-2 whitespace-nowrap border-b-2 px-3 py-3 font-display text-[13.5px] font-[600] transition-colors duration-[var(--dur-fast)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--p)] focus-visible:ring-offset-1 sm:gap-2 sm:px-4 sm:text-[14px] ${
              isActive
