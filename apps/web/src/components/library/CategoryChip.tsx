  ...
  return (
    <button
      ...
      className={`group inline-flex cursor-pointer items-center gap-2 rounded-[var(--r-full)] border border-[var(--bd)] px-4 py-2.5 font-display text-[13px] font-[600] transition-all duration-[var(--dur-normal)] ${
        isMore
          ? 'bg-[var(--bg2)] text-[var(--t3)] hover:bg-[var(--bg3)] hover:text-[var(--t1)]'
    ...
    >
      ...
      {!isMore && (
        <span className="inline-flex h-[18px] min-w-[32px] items-center justify-center rounded-[var(--r-full)] bg-[var(--bg3)] px-1.5 font-display text-[11px] font-[700] tabular-nums text-[var(--t3)] transition-colors duration-[var(--dur-normal)] group-hover:bg-[var(--p-light)] group-hover:text-[var(--p)]">
