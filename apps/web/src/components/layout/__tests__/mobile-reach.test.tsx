...
//
// 실측 2026-08-26 — `FOOTER_ITEMS`(Class · Settings)는 데스크톱 셸에서만 렌더되고
// 그 셸은 `hidden md:flex`(v08.6 부터 `AppHeader` 의 `hidden md:block`)다. 즉 폰에서는 두 화면으로 **가는 길이 0개**였다.
...
describe('모바일 도달 가능성 — 레일 밖 유틸리티', () => {
  ...
  it('자기 목록을 들지 않는다 — 상단 메뉴와 같은 출처를 읽는다', () => {
    nav.pathname = '/hub'
