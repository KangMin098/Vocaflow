...
//
// 2026-09-19 — 이 조작면은 「학급에 나눠 줄 한 장으로」 를 눌러야 나타난다(발산 B, docs/design/compare/fit.md).
//    예전 결정("미리보기를 화면에 그리지 않는다")은 **접힌 상태를 기본으로 두는 것**으로 바뀌었다 —
//    지문 판면(`ClassSheet`) 한 장만 펼쳐 보이고, 낱말 목록·빈칸 장은 여전히 인쇄 미리보기가 보여 준다.
