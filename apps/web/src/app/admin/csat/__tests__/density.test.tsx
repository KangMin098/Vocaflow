...
const BUDGET: Record<string, { chunks: number; chars: number }> = {
  ...
  // 기획 **+공통 골격**(2026-09-23 · DD-74): 119 · 1,283 → **161 · 1,941**. 이 화면은 지수를
  ...
  // 설계 **+공통 골격**(2026-09-23 · DD-74): 95 · 569 → **129 · 1,068**. 분류표는 어느 칸이
  ...
  // 소재 **+공통 골격**(2026-09-23 · DD-74): 65 · 829 → **115 · 1,612**. 띠는 「비었나·얇나」를
  ...
  // 집필 **+공통 골격**(2026-09-23 · DD-74): 152 · 913 → **196 · 1,260**. 25×9 매트릭스는
  ...
  //
  // 검수 **+공통 골격 · +살아 있는 판정**(2026-09-23 · DD-74): 89 · 784 → **142 · 1,502**.
  ...
  //
  // 조판 **+공통 골격 · +학습자 도달**(2026-09-23 · DD-74): 127 · 1,063 → **184 · 1,530**.
