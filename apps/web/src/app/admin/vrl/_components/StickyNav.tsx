          ...
          return (
            <li key={s.id} className="shrink-0">
              <a
                ...
                className={`group inline-flex items-center gap-1.5 rounded-[var(--r-md)] px-3 py-1.5 font-display text-[11px] font-[600] transition-all duration-[var(--dur-normal)] ${
                  active
                    ? 'bg-[#8B5CF61A] text-[#8B5CF6] shadow-[var(--sh-sm)]'
                    : 'text-[var(--t3)] hover:bg-[var(--bg2)] hover:text-[var(--t2)]'
                }`}
              >
