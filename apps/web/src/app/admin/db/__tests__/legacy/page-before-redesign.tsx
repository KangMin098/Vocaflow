// apps/web/src/app/admin/db/__tests__/legacy/page-before-redesign.tsx
//
// 재설계(2026-09-06) 직전의 /admin/db 화면을 **얼어붙여 둔 사본**이다. 제품 코드가 아니고
// 어디서도 라우팅되지 않는다 — density.test.tsx 가 「같은 데이터에서 전보다 적은가」를
// 재기 위해서만 렌더한다. 절대값 라쳇(총 2,044자 · 설명문 60자)은 이 파일 없이도 선다.
//
// 타입이 바뀌어 이 파일이 컴파일되지 않게 되면, 고치지 말고 **이 파일과 비교 테스트 하나만**
// 지운다. 낡은 사본을 억지로 살려 두면 그때부터 이 파일이 재설계의 기준이 된다.
//
