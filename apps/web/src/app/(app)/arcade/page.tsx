...
const GAMES: GameCard[] = [
  ...
  { slug: 'lexicon-hands', name: 'Lexicon Hands', tagline: '어원·품사 시너지로 배수를 폭발시켜라', layer: 'L4+ 시너지', ref: 'Balatro',
    a: '#7B4BA6', b: '#241732', glow: 'rgba(150,240,205,.42)', accent: '#CFF6E6',
    mark: M(<><rect x="7" y="11" width="11" height="15" rx="1.6" transform="rotate(-10 12.5 18.5)" /><rect x="14" y="9" width="11" height="15" rx="1.6" transform="rotate(10 19.5 16.5)" /></>) },
  { slug: 'lexicon-detective', name: 'Lexicon Detective', tagline: '현장 단서를 수확해 사건을 재구성하라', layer: 'L5 추리', ref: 'Golden Idol',
    a: '#9A7B3C', b: '#2E2A1C', glow: 'rgba(214,184,110,.46)', accent: '#F0E4C2',
    mark: M(<><circle cx="14" cy="13" r="6.5" /><path d="M18.8 17.8L25 24" /><path d="M11 13h6" opacity=".5" /></>) },
  { slug: 'morpheme-rules', name: 'Morpheme Rules', tagline: '형태소를 조립하면 그 뜻이 세계를 바꾼다', layer: 'L4b 형태론', ref: 'Baba Is You',
    a: '#4C7A9E', b: '#1A2330', glow: 'rgba(130,205,255,.44)', accent: '#D4EAFA',
    mark: M(<><rect x="5" y="12" width="9" height="8" rx="1.4" /><rect x="18" y="12" width="9" height="8" rx="1.4" /><path d="M14 16h4" /></>) },
  { slug: 'silent-rule', name: 'The Silent Rule', tagline: '설명 없이 철자 규칙을 스스로 귀납하라', layer: 'L4b 귀납', ref: 'The Witness',
    a: '#3E9E86', b: '#173F3B', glow: 'rgba(140,235,190,.44)', accent: '#D2F3E4',
    mark: M(<><rect x="7" y="7" width="18" height="18" rx="3.5" /><circle cx="11" cy="11" r="1.7" fill="currentColor" stroke="none" /><path d="M11 11h5.5v5.5" /></>) },
  { slug: 'lexicon-estate', name: 'Lexicon Estate', tagline: '단어-방을 배치해 의미장 저택을 짓다', layer: 'L5 의미망', ref: 'Blue Prince',
    a: '#3E6EA6', b: '#152238', glow: 'rgba(130,180,255,.44)', accent: '#CFE2FA',
    mark: M(<><rect x="5" y="6" width="22" height="20" rx="2" /><path d="M16 6v20M5 15h11" /><path d="M16 21h11" opacity=".5" /></>) },
  { slug: 'word-orrery', name: 'The Word Orrery', tagline: '행성을 탐사해 앎으로 핵의 봉인을 연다', layer: 'L5 탐사', ref: 'Outer Wilds',
    a: '#3B4468', b: '#0A0E1E', glow: 'rgba(255,176,86,.42)', accent: '#FFD9A0',
    mark: M(<><circle cx="16" cy="16" r="4.5" /><ellipse cx="16" cy="16" rx="11" ry="11" opacity=".55" /><circle cx="27" cy="16" r="1.7" fill="currentColor" stroke="none" /></>) },
