...
// 비밀번호 재설정(클라이언트) — 페이지(`page.tsx`, 서버)가 칠해진 지문 옆에 세운다(2026-09-19 · DD-31).
//   걷은 것: 그림자 카드 3벌 · 아이콘 원 2개 · 좁은 카드에 두 줄 중앙 H1 · 정보색 안내 상자 · 44px 미만 하단 링크.
//
    ...
    return (
      <div>
        <div className="mb-s-6">
          ...
          <h1 className={AUTH_H1}>새 비밀번호 설정</h1>
        ...
        <div className="mt-s-5 border-t border-bd pt-s-3">
          <button
            type="button"
            onClick={() => {
              setMode('request')
            ...
            className="inline-flex min-h-[44px] items-center font-display text-[12px] font-[600] text-t2 transition-colors duration-normal hover:text-p focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--p)]"
          >
            대신 재설정 메일 받기 →
          </button>
        </div>
    ...
    return (
      <div>
        <div className="mb-s-5">
          ...
          <h1 className={AUTH_H1}>이메일을 보냈어요</h1>
        ...
        <div className="mb-s-6 border-y border-bd py-s-3">
          <p className="mb-s-2 font-display text-[11px] font-[600] tracking-[0.04em] text-t2">
            다음 단계
          </p>
        ...
        <div className="space-y-s-3">
          <button
            ...
            className="h-11 w-full rounded-md border border-bd bg-bg font-display text-sm font-medium text-t1 transition-colors duration-normal hover:border-t2 hover:bg-bg2 active:translate-y-px focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--p)]"
          >
            다른 이메일로 다시 시도
          </button>
  ...
  return (
    <div>
      ...
      <div className="mb-s-6">
        ...
        <h1 className={AUTH_H1}>비밀번호를 잊으셨나요?</h1>
      ...
      {/* 하단 보조 링크 */}
      <div className="mt-s-6 flex items-center justify-between border-t border-bd pt-s-2">
        <Link
          href="/login"
          className="inline-flex min-h-[44px] items-center font-display text-[12px] font-[600] text-t2 transition-colors duration-normal hover:text-p focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--p)]"
        >
