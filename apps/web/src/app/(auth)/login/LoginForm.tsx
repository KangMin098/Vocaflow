...
// 로그인 폼(클라이언트) — 페이지(`page.tsx`, 서버)가 칠해진 지문 옆에 세운다(2026-09-19 · DD-31).
//   걷은 것: 그림자 카드(`Card elevated`) · 가운데 정렬 제목 · 「안전한 인증 · 산업 표준 암호화」(아무것도 말하지 않는 안심 문구).
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-s-4">
        ...
        {/* 세션은 Supabase refresh token 이 자동 연장한다 (별도 "로그인 유지" 토글 없음) */}
      </form>
    </div>
  )
}
