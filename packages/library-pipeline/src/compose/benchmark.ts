...
export const BENCHMARK_SAMPLES: ReadonlyArray<BenchmarkSample> = [
  ...
  },
  {
    ...
    band: 'high',
    slug: 'school-costs-in-europe',
    url: 'https://www.newsinlevels.com/products/school-costs-in-europe-level-3/',
    words: 169,
    sentences: 10,
    avgSentenceWords: 16.9,
    aboveShare: 0.0,
  },
  {
    platform: 'News in Levels',
    ...
    band: 'high',
    slug: 'finns-love-blueberries',
    url: 'https://www.newsinlevels.com/products/finns-love-blueberries-level-3/',
    words: 159,
    sentences: 10,
    avgSentenceWords: 15.9,
    aboveShare: 0.0,
  },
  {
    platform: 'News in Levels',
    ...
    band: 'high',
    slug: 'how-ants-changed-kenya',
    url: 'https://www.newsinlevels.com/products/how-ants-changed-kenya-level-3/',
    words: 146,
    sentences: 11,
    avgSentenceWords: 13.3,
    aboveShare: 0.046,
  },
]
