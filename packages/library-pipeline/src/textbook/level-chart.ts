 ...
 *   대가가 있다: V7 재고에서 손집필 희소 유형이 깎인다(실측 topic 11→1 · title 14→5 ·
 *   main_point 6→2). 그건 자를 바꿔서 생긴 손해가 아니라 **원래 있던 부족을 드러낸 것**이다
 *   — 그 유형들의 지문이 실제 수능 길이대(68~172어)에 없다는 뜻이고, 집필로 메울 몫이다.
 */
