// scripts/dict-fill/p5-extract-targets.ts
// P5: extract remaining stubs in lemma_band 10k-25k for LLM enrichment.
...
const OUTPUT_DIR = resolve(__dirname, '../../data/dict-fill/p5/chunks')
const CHUNK_SIZE = 30
const TARGET_BANDS = ['10k','11k','12k','13k','14k','15k','16k','17k','18k','19k','20k','21k','22k','23k','24k','25k'] as const
