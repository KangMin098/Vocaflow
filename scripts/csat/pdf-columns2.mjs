...
//
// ⚠️ **2026-09-16 부터 `pdf-columns3.mjs` 가 이 자리를 대신한다.** 이 판은 문자 격자로 단을
//    가르는데, 그 근사가 본문에 부스러기를 남긴다(낱글자 69 · 홀로 마침표 84 · 한글 46).
//    3판은 PDF 실좌표로 가르고 같은 폴더에 쓴다 — 여덟 신호가 전부 내려갔다(실측 비교는
//    CHANGELOG 2026-09-16 · `body_suspect` 211 → 111). 이 파일은 대조군으로 남긴다.
//
