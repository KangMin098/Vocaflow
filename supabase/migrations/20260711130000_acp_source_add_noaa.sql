-- library_articles + seed_catalog source CHECK 에 'noaa' 추가 (ACP §18 — NOAA Climate.gov 기후과학)
...
ALTER TABLE library_articles
  ...
  CHECK (source = ANY (ARRAY[
    ...
    'wikinews','the_conversation','simple_wikipedia','owid','factbook','elife','wikipedia','plos','wikivoyage','usgs','noaa'
  ]));
...
ALTER TABLE library_article_seed_catalog
  ...
  CHECK (source = ANY (ARRAY[
    ...
    'owid','factbook','elife','wikipedia','plos','wikivoyage','usgs','noaa'
  ]));
