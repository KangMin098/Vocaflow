...
7. **적체가 새 소스보다 먼저였다 — 그리고 막힌 게 아니라 아무도 안 돌린 것이었다.**
   ...
   VOA 를 4갈래(`--shard i/4`)로 전량 드레인해 `ready` **230 → 10,445편**(+10,215)을 올렸다.
   전부 얇던 밴드로 들어갔다 — 드레인 전 V2 1,512 · V3 1,560 · V4 3,116 이던 칸이다.
   **새 소스 0개로 얻은 재고다.** frontiers 1,961편(CC BY · C1–C2)도 3갈래로 이어서 돌린다.
