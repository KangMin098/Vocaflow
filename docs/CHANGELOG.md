...
**확보 결과** — 지문 재고 **779 → 2,287편**. 전량 분석 완료(큐 0).

| 소스 | 확보 | 평균 V | V5~8 적중 | 주제 적합% |
|---|---|---|---|---|
| usgs | 728 | 5.1 | 89.6% | 35~52 |
| nasa | 271 | 5.5 | 85.6% | 63~65 |
| voa | 249 | 3.8 | 16.5% | 61~66 |
| futurity | 188 | 5.1 | 89.9% | 23~28 |
| noaa | 115 | 4.9 | 87.8% | 62~64 |
| plos | 46 | 6.3 | **100%** | 33 |

USGS·NOAA 는 **소진 확인**(목록 전 페이지를 DB 와 대조 · 미확보 0). 남은 65편은 본문
200단어 미만인 지진 속보·예산 공지라 거절이 맞다.
