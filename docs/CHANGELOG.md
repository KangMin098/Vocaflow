...
**⛔ TED 는 소스로 쓸 수 없다 (실측 2026-08-16 · 결론)**. 파이프라인은 완성돼 적용까지 마쳤으나
TED 수확은 **0편**이다. 주제 페이지와 자막 페이지 모두 Node 에서 403 이 떨어진다:
...
| **T8 예문 자리 쓰레기값** | 432건 (meta 93 · gloss 197 · shifted 142) · 4청크 | 예문 **321건** 교체 · WordNet 메타데이터 예문 **93 → 0** · 뜻풀이 예문 **197 → 2** |
