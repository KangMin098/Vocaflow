...
- **picker 그룹 재구성**: 스크립트=소스별 섹션(VOA/NASA/…), 공용단어장=카테고리 섹션(수능/공인시험/…/**도서 챕터**/**스크립트 어휘**) — 챕터 종속 단어장 262종 숨김 해제로 챕터 단위 단어장 계획 지원. 그룹 헤더에 개수 병기.
- **요일 미정 안내**: 보드 하단 설명 문구 + 요일 블록 라벨("안 고르면 '요일 미정'에 담겨요").
