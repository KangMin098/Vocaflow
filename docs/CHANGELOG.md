...
- **잔여(사용자 결정 필요)**: #2 단어 정확도 게이트(Web Speech 병렬 인식 — Chrome/Edge·네트워크 트레이드오프 + 육성 검증 필요), #1 실음성 threshold 보정(육성 샘플 필요). tsc green · vitest 11/11 · EchoMatch 게이트 스모크 green.
