...
**진행 (2026-07-04 live 재확정):** 카탈로그 **11권 전권 완결 1,406문항** — Pride(488, 병렬 세션)·Marvelous Land of Oz(168)·Huck(154)·Wonderful Oz(141)·**Railway Children(98, 완결 — V7·14ch·정답분산 26/25/24/23·malformed 0)**·Wind in the Willows(96)·Sherlock(96)·Just So(84)·Alice(72)·Ammachi(5)·Drone(4). 남은 서사 후보: Jane Eyre(38ch)·Great Expectations(59ch). 대형서 Twenty Years After(90ch)·Decline and Fall(71ch·비서사)은 본문 미적재 → 재fetch 필요.
