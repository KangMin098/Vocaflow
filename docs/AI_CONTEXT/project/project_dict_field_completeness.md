...
**진행(2026-07-13)**: **자동 50권 run 완료 → 2,903 후보 누적**. 등장 도서수 순 상위 220 육안 검토 → **실 gap 16 수리**: drift·flush·quarrel·sin·despair(동사 누락 5) · bundle·thrill·vain·blaze·spy·shield(동사/형용사 누락 6) · thrust·divine·retreat·surge(동사/형용사 누락 4) · **ah**(abbreviation "암페어시" 오분류→interjection "아, 아아" 교정 1). 수동 3배치(15권)에서 별도 ~18단어(bid·tender·pardon·pin·rear·rage·whip·variation·span·merit·fling·strand·furnish·worship·dread·vow·mock·distress). **누적 mined ~65권·수리 ~34단어**. **핵심 관찰: 등장 도서수 = 임팩트 정렬 우선순위**(17-20권 등장 단어가 최고 가치); 220위 이하(등장<9권)는 대부분 정확한 단의어라 gap 수율 급락→ **yield 포화**. **근본 사전 전체 이슈 미발견**(전부 per-word 다의어). 재개 시: baseline `data/mine-baseline-words.json`(2,903 단어)와 diff해 **신규 단어만** 검토(재등장 common word는 이미 수리됨). 잔여 SE ~1,370. curation_status 이미 전부 'done'→curation_meta 플래그로 추적.
